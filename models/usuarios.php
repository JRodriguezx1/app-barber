...
class usuarios extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'nombre', 'apellido', 'cedula', 'movil', 'email', 'ws', 'password', 'confirmado', 'token', 'admin', 'idfidelizacion', 'ciudad', 'direccion', 'fecha_nacimiento', 'img', 'habilitar'];
