...
class citas extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'id_usuario', 'id_empserv', 'fecha_tomada', 'start', 'hora', 'hora_fin', 'estado', 'duracion', 'tipocita', 'valorcita', 'dcto', 'dctovalor', 'nameservicio', 'nameprofesional', 'nombrecliente', 'descripcion', 'display'];
    ...
    public function __construct($args = [])
    {
        ...
        $this->fecha_tomada = $args['fecha_tomada'] ?? date('Y-m-d');
        ...
        $this->display = $args['display']??'background';
    }
    ...
    public function validarcitas() {
        ...
        if(!$this->hora_fin) {
            self::$alertas['error'][] = 'debes elegir la hora de la cita';
        }
        return self::$alertas;
    }
}