<footer class="dash-cliente">
    <div class="dash-cliente__negocio">
        <a href="/"><h2 class="dash-cliente__logo">App Salon</h2></a>
    ...
    <p class="text-center allright">Copyright ©2022 Todos los derechos reservados | Desarrollado by <span>InnovaTechQuidío</span></p>
</footer>